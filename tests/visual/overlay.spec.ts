...
const STORIES: StoryCase[] = [
  ...
  {
    slug: "prompt-tuner-overlay--streaming",
    name: "overlay-streaming",
    settleMs: 3000,
  },
  {
    slug: "prompt-tuner-overlay--complete",
    name: "overlay-complete",
    settleMs: 500,
  },
  { slug: "prompt-tuner-overlay--error", name: "overlay-error", settleMs: 500 },
  {
    slug: "prompt-tuner-overlay--long-input-warning",
    name: "overlay-long-input",
    settleMs: 500,
  },

...
- **Six prompt actions** — Optimize, Few-Shot, Chain of Thought, Assign a Role, Define Output, Add Constraints. Triggered via ⌘⇧K or the selection pill.
...
- **Platform-aware rules** — per-platform optimization rules fetched from GitHub Pages, Zod-validated, cached for 7 days, with bundled fallback.
